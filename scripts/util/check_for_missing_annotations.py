...
def printusage():
  ...
  Usage: python check_for_missing_annotations.py [path to annotation.csv] [Project ID] >> no_annotations.csv
...
conn = BlitzGateway(os.environ['OMERO_USER'], os.environ['OMERO_PASSWORD'], host=host, port=port)
conn.connect()
